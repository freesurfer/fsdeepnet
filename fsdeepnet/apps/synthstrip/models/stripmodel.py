...
"""
class StripModel and class ConvBlock are extracted from freesurfer/mri_synthstrip/mri_synthstrip.
   https://github.com/freesurfer/freesurfer/blob/dev/mri_synthstrip/mri_synthstrip
